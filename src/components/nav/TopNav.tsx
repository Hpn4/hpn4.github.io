...
const LINKEDIN_URL = "https://www.linkedin.com/in/etienne-senigout";
  ...
  return (
    <header className="top-nav">
      ...
      <div className="top-nav-social">
        ...
        >
          <svg viewBox="0 0 382 382" width="20" height="20" fill="currentColor" fillRule="evenodd" aria-hidden="true">
